...
export const alt = "Referral Finder & Outreach Templates — PlacementGO";
    ...
    (
      <div style={{ display: "flex", flexDirection: "column", width: "100%", height: "100%", background: "linear-gradient(135deg, #0F172A 0%, #1e3a8a 100%)", padding: "60px", fontFamily: "sans-serif" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", flex: 1, justifyContent: "center" }}>
          <h1 style={{ color: "white", fontSize: 76, fontWeight: 900, lineHeight: 1.05, margin: 0, letterSpacing: "-2px" }}>
            Referral Finder &{"\n"}
            <span style={{ color: "#60A5FA" }}>Outreach Templates</span>
          </h1>
          <p style={{ color: "#94A3B8", fontSize: 27, marginTop: 24, marginBottom: 0, maxWidth: 700 }}>
            Paste a job link. Get a personalized email that gets replies. Land referrals at Google, Microsoft, Amazon and more.
          </p>
          <div style={{ display: "flex", gap: 16, marginTop: 36 }}>
            {["Alumni Matching", "Cold Email AI", "LinkedIn Outreach", "One-Click Copy"].map((f) => (
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 24 }}>
          <span style={{ color: "#475569", fontSize: 22 }}>placementgo.in/referalfinder</span>
          <span style={{ background: "#2563EB", color: "white", padding: "10px 28px", borderRadius: 99, fontSize: 20, fontWeight: 700 }}>Find Referrals →</span>
        </div>
      </div>
    ),
    { ...size },
